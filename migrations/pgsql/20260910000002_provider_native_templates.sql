...
CREATE UNIQUE INDEX uk_provider_templates_account_code_live ON provider_templates (provider_id, template_code) WHERE deleted_at IS NULL;
...
DROP INDEX uk_provider_templates_account_code_live;
