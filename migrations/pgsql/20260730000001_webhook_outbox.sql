...
ALTER TABLE webhook_logs ADD COLUMN next_attempt_at TIMESTAMP;
ALTER TABLE webhook_logs ADD COLUMN locked_until TIMESTAMP;
ALTER TABLE webhook_logs ADD COLUMN lease_token VARCHAR(64);
ALTER TABLE webhook_logs ADD COLUMN updated_at TIMESTAMP;
