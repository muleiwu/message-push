...
func TestAdminLogAndCallbackResponsesUseRFC3339UTC(t *testing.T) {
	...
	for _, statement := range []string{
		...
		`CREATE TABLE callback_logs (provider_account_id INTEGER DEFAULT 0, source TEXT, sms_event_key TEXT UNIQUE, attribution TEXT, id INTEGER PRIMARY KEY, type TEXT, task_id TEXT, app_id TEXT, provider_code TEXT, provider_id TEXT, mobile TEXT, content TEXT, callback_status TEXT, error_code TEXT, error_message TEXT, raw_data TEXT, created_at DATETIME)`,
