...
type CallbackListRequest struct {
	...
	Source            string `form:"source" binding:"omitempty,oneof=callback query pull poll"`
	Attribution       string `form:"attribution" binding:"omitempty,oneof=matched unmatched ambiguous"`
