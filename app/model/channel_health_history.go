...
type ChannelHealthHistory struct {
	...
	ProviderChannelID uint      `gorm:"not null;index:idx_channel_time;comment:服务商通道ID" json:"provider_channel_id"`
	CheckTime         time.Time `gorm:"not null;index:idx_channel_time,idx_check_time;comment:检查时间" json:"check_time"`
	...
	IsAvailable       int8      `gorm:"default:1;comment:是否可用：1=是 0=否" json:"is_available"`
