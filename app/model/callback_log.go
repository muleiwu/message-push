...
type CallbackLog struct {
	ProviderAccountID uint      `gorm:"index:idx_callback_logs_account" json:"provider_account_id"`
	Source            string    `gorm:"type:varchar(20)" json:"source"`
	SMSEventKey       *string   `gorm:"column:sms_event_key;type:varchar(64);uniqueIndex:uk_callback_logs_sms_event" json:"sms_event_key,omitempty"`
	Attribution       string    `gorm:"type:varchar(30)" json:"attribution"`
