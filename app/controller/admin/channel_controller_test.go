...
func newBindingControllerFixture(t *testing.T, update bool) *bindingControllerFixture {
	...
	for _, statement := range []string{
		...
		`CREATE TABLE provider_templates (provider_metadata TEXT, content_version INTEGER NOT NULL DEFAULT 1, id INTEGER PRIMARY KEY, provider_id INTEGER, template_code TEXT, template_name TEXT, content_type TEXT, template_content TEXT, variables TEXT, status INTEGER, remark TEXT, created_at DATETIME, updated_at DATETIME, deleted_at DATETIME, remote_id TEXT, audit_status INTEGER, audit_reply TEXT, remote_deleted INTEGER, synced_at DATETIME, remote_description TEXT, native_content TEXT, variable_slots TEXT, codec_version TEXT, remote_name TEXT, category TEXT)`,
